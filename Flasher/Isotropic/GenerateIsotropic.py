...
class GenerateIsotropic(icetray.I3Module):
    ...
    def __init__(self, context):
        ...
        self.AddParameter(
            "FlasherKey", "The ModuleKey of the Flasher.", ModuleKey(1, 1)
        )

        self.AddParameter(
            "FlasherPosition", "The position of the photon source.", I3Position(0, 0, 0)
        )
    ...
    def DAQ(self, frame):
        ...
        photon_direction.set_theta_phi(0.0, 0.0)
        pulse = self.generate_pulse(
            self.flasher_position,
            photon_direction,
            self.pulse_type,
            self.num_of_photons,
            self.pulse_width,
...
class GenerateIsotropicHemisphere(icetray.I3Module):
    ...
    def __init__(self, context):
        ...
        self.AddParameter("Upward", "Flash an upward pointing hemisphere.", 1)

        self.AddParameter("Downward", "Flash a downward pointing hemisphere.", 0)
    ...
    def DAQ(self, frame):
        ...
        photon_direction = I3Direction()
        photon_direction.set_theta_phi(up_down, 0.0)
        pulse = self.generate_pulse(
            self.flasher_position,
            photon_direction,
            self.pulse_type,
