...
parser.add_option(
    "-o",
    "--outfile",
    default="test-data/test-flashers.i3",
    dest="OUTFILE",
...
parser.add_option(
    "-g",
    "--gcd",
    default=expandvars("$I3_TESTDATA/../GCD/PONE_10String.i3.gz"),
    dest="GCDFILE",
...
# pone imports
from WaterOpticalModel import (
    MakePoneMediumPropertiesConservativeExtendedRange as Medium,
)
...
tray.AddModule(
    "I3InfiniteSource", "streams", Prefix=options.GCDFILE, Stream=icetray.I3Frame.DAQ
)
