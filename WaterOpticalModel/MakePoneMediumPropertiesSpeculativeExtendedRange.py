...
def MakePoneMediumProperties():    
    ...
    m.ForcedMinWlen = 250.*I3Units.nanometer
    m.ForcedMaxWlen = 720.*I3Units.nanometer
    ...
    absLenTable = [  0.800,   1.200,   1.800,   2.215,   3.426,   4.369,   5.034,   6.013,   6.707,   7.571,
                     9.019,  10.067,  11.474,  13.118,  14.532,  18.086,  21.786,  23.441,  26.983,  29.597,
                    30.798,  32.321,  32.321,  30.012,  25.940,  18.674,  13.976,  13.149,  11.947,  10.449,
                     9.416,   8.344,   7.716,   5.308,   3.415,   2.884,   2.221,   2.116,   2.010,   1.904,
                     1.676,   1.570,   1.478,   1.356,   1.116,   0.876]
    # generate a function from the table above
    poneAbsorption = I3CLSimFunctionFromTable(260.*I3Units.nanometer, 10.*I3Units.nanometer, absLenTable)
