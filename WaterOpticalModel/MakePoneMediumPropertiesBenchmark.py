...
def MakePoneMediumProperties():
    ...
    m.ForcedMinWlen = 265.0 * I3Units.nanometer
    m.ForcedMaxWlen = 675.0 * I3Units.nanometer
    ...
    scatLenTable = [10000] * 33
    absLenTable = [10000] * 33
    # generate functions from the tables above
    poneScattering = I3CLSimFunctionFromTable(
        290.0 * I3Units.nanometer, 10.0 * I3Units.nanometer, scatLenTable
    )
    poneAbsorption = I3CLSimFunctionFromTable(
        290.0 * I3Units.nanometer, 10.0 * I3Units.nanometer, absLenTable
    )
