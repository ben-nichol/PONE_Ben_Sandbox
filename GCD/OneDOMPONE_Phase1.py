...
outfile = dataio.I3File('/data/p-one/jstacho/noise/GCD/' + outfileName, 'w')
numberOfCircles = 1
domsPerString  = 1
stringsPerCircle = ([3])
...
def generateGeometry(nCircles, DPS, strings):
    ...
    depth = np.array([0])*I3Units.meter#np.arange((I3Constants.SurfaceElev - I3Constants.OriginElev - 1600), (I3Constants.SurfaceElev - I3Constants.OriginElev - 2400), -(800/DPS)) * I3Units.meter
    xPos = ([])
    yPos = ([])
