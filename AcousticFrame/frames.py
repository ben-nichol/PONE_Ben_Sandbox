...
class injectFrame(icetray.I3Module):
    ...
    def __init__(self, context):
        ...
        self.AddParameter(
            "insertbefore",
            "Type of frame before which new frame gets injected",
            icetray.I3Frame.DAQ,
        )
        self.AddParameter(
            "delay",
            'Number of frames of type "insertbefore" before frame gets injected',
            0,
        )
    ...
    def Inject(self):
        ...
        for string in range(self.GetParameter("strings")):
            for module in range(self.GetParameter("modules")):
                ...
                newdomstatus.pmt_hv = 1345.0 * icetray.I3Units.V  # arbitrary
    ...
    def DropInterpolatedGFrame(self, scale):
        ...
        if self.initial_AFrame and self.final_AFrame:
            ...
            for key, _ in initial_geo:
                ompos = (
                    initial_geo[key].position * (1 - scale)
