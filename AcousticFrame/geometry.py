...
tilt_coefficients = nn.array(
    [
        ...
        [0.00000000e00, 1.89675157e-02, -1.88782797e-05, 6.86966811e-09],
        [-4.12837591e-11, 3.08289997e00, -2.57124952e-03, 7.68681299e-07],
        [9.25370891e-14, -2.64904419e00, 2.89333720e-03, -1.13182809e-06],
    ]
)
...
def createTiltedGeometry(current_speed=0, current_angle=0, string_positions=[[0, 0]]):
    ...
    if not 0 <= current_speed <= 0.2 * icetray.I3Units.m / icetray.I3Units.s:
        print(
            "Current speed outside of range for which fit "
