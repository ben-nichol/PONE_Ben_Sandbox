...
def createEvents(frame):
    ...
    direction = dataclasses.I3Direction(0.0, 0.0, -1.0)
...
tray.AddModule(frames.injectDetectorStatusFrame, insertbefore=frames.Acoustic)
tray.AddModule(frames.injectCalibrationFrame, insertbefore=frames.Acoustic)
...
class WrapCLSim(frames.CreateSeparateGCD):
    def InsertModule(self, wrapper_tray, gcdfile):
        ...
        wrapper_tray.AddSegment(
            ...
            IceModelLocation=os.path.expandvars(
                "$I3_BUILD/ice-models/resources/models/ICEMODEL/spice_lea"
            ),
