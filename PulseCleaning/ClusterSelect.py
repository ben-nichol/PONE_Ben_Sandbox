        ...
        while removed > 0 :
            ...
            for i, omkey1 in enumerate(nopmtdomkeys) :
                for j, omkey2 in enumerate(nopmtdomkeys) :
                    ...
                    dom_to_dom = np.sqrt((pos1.x-pos2.x)**2.0+(pos1.y-pos2.y)**2.0+(pos1.z-pos2.z)**2.0)
                    ...
                    if nopmtkey1 not in distance_dict.keys() :
                        ...
                        distance_dict[nopmtkey1] = min(distance_dict[nopmtkey1],dom_to_dom)
