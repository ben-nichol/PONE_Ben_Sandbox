...
class addNoise(icetray.I3ConditionalModule):
    ...
    def __init__(self, context):
        ...
        self.AddParameter(
            "PhysicsMCPETreeName", "Name of the Physics I3MCTree name", "MCPESeriesMap"
        )
        self.AddParameter(
            "NoiseMCPEMCTreeName", "Name of the noise I3MCTree name", "NoiseSeriesMap"
        )
        self.AddParameter("STRAWTimestamps", "Noise Hits for mDOMs to be injected")
