...
def GenerateIceTopShowers(
    ...
    tray.AddModule(
        "I3InfiniteSource", "source", prefix=GCDFile, stream=icetray.I3Frame.DAQ
    )
    ...
    tray.AddService(
        "I3InjectorFactory<I3CorsikaInjector>",
        name + "_topinjector",
        FileNameList=Files,
    ...
    tray.AddModule(
        ...
        MuonEnergyCutOff=0.0,  # this is done by I3InIceCORSIKATrimmer, so it can be anything.
        CompressPEs=1,
