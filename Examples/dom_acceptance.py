...
pmt_acc = DOMUtility.Geant4PMTAcceptance("/home/chrhck/repos/pone_offline/data/pmt_acc.npz")
...
plt.hist(pmt_ixs[pmt_ixs > 0], bins=np.arange(1, 18))
plt.savefig("pmt_ixs.png")
