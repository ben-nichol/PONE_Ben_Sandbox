...
parser.add_argument('-i',    '--infile',   default = "dataio/muons.i3",             help="name and path of input file")
parser.add_argument('-o',    '--outfile',   default = "dataio/prop.i3",             help="name and path of output file")
