...
parser.add_argument(
    "-n", "--nevents", type=int, default=1000, help="Number of events to run."
)
parser.add_argument(
    "-i", "--infile", type=str, default="dataio/data_output.i3", help=""
)
...
randomService = phys_services.I3SPRNGRandomService(
    seed=args.run * args.run, nstreams=100000000, streamnum=args.run
)
