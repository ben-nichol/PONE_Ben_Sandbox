...
indextable = I3CLSimFunctionRefIndexQuanFry(
...
def GetIndex(wl=450.0):
    return indextable.GetValue(450.0)
...
def GetGroupIndex(wl=450.0):
    return indextable.GetValue(450.0) - 450.0e9 * (indextable.GetDerivative(450.0))
    a = -1.50156e-6
    b = 1.07085e-7
    c = -4.27594e-5
    d = -1.60476e-4
